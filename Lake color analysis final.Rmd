...
climate_depth_blue_lake_ratio = climte_variable_blue_ratios %>% 
  ...
  theme_bw() +
  theme(axis.text.x.bottom = element_text(angle = 0, hjust = 0, vjust = 0),
        legend.position = "bottom",
        legend.direction = "horizontal")

climate_depth_blue_lake_ratio

climate_depth_blue_lake_ratio %>% ggsave(filename = "figs/Figure3_summer_climate_depth_blue_lake_ratio_temp2bin_813.png", width = 6.5, height = 3.5)

climate_depth_blue_lake_ratio %>% ggsave(filename = "figs/Figure3_summer_climate_depth_blue_lake_ratio_temp2bin_813.pdf", width = 6.5, height = 3.5)
```
